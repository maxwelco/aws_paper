...
New friend is less likely about data. It has no information about the topic.
...
First: Likely to increase from 0.1 to 0.6 his/her perception about climate change.

Second: Lern about the topic
...
```{r}
plot_binomial_likelihood(y = 5, n = 20)
```
...
```{r}
plot_beta_binomial(alpha = 2, beta = 30, y = 5, n = 20)
```
